...
process build {
    ...
    if [[ "${params.tree_builder}" == "fasttree" ]]; then
        ...
        phyml --model JTT --no_memory_check --quiet --pinv e --alpha e --nclasses 4 -o tlr -f m --bootstrap -2 --datatype aa --input ${fasta_name}.faa.clean.alg.phylip -nt ${params.thread}  2> build.err
